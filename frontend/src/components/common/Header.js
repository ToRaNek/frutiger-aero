...
function Header({ onToggleSidebar, sidebarOpen }) {
    ...
    // Détecter le scroll pour l'effet de blur du header
    useEffect(() => {
        const handleScroll = () => {
    ...
    const headerClasses = [
        ...
        isSearchFocused && 'header-search-focused',
    ...
    return (
        ...
        >
            <div className="header-container">
                ...
                Frutiger <span className="logo-accent">Streaming</span>
                    ...
                    <div className="header-search">
                        <SearchBar
                            ...
                            placeholder="Rechercher des vidéos, playlists, créateurs..."
                        ...
                        {user ? (
                            ...
                            <>
                                ...
                                <Link to="/upload" className="header-upload-btn">
                                    <motion.button
                                        className="btn-glass btn-upload"
                                        whileHover={{ scale: 1.05 }}
                                        whileTap={{ scale: 0.95 }}
                                ...
                                <div className="header-notifications" ref={notificationsRef}>
                                    <motion.button
                                        className="btn-glass btn-notifications"
                                                ...
                                                <div className="notifications-list">
                                                    <div className="notification-item unread">
                                                        <div className="notification-avatar">
                                                            <img src="/avatars/alex.png" alt="Alex" />
                                                        </div>
                                                        <div className="notification-content">
                                                            <p><strong>Alex</strong> a commenté votre vidéo</p>
                                                            <span className="notification-time">Il y a 5 min</span>
                                                        </div>
                                                    </div>
                                                    <div className="notification-item">
                                                        <div className="notification-avatar">
                                                            <img src="/avatars/marie.png" alt="Marie" />
                                                        </div>
                                                        <div className="notification-content">
                                                            <p><strong>Marie</strong> a ajouté une nouvelle vidéo</p>
                ...
                {/* Barre de progression pour les uploads (si applicable) */}
                <div className="header-progress">
                    {/* Progress bar sera gérée par le contexte d'upload */}
                </div>
            </div>
        </motion.header>
    );
